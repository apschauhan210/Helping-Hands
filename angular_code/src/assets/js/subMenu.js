    ...
    if(value.length==0) document.getElementById("grid-city").innerHTML = "<option></option>";
    else {
    var citiesOptions = "<option disabled selected>Select City</option>";
    for(cityId in citiesByState[value]) {
    citiesOptions+="<option>"+citiesByState[value][cityId]+"</option>";
    }
    document.getElementById("grid-city").innerHTML = citiesOptions;
    }
    }
